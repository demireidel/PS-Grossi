...
export function Footer() {
  return (
    <footer className="bg-foreground text-background relative overflow-hidden">
      ...
      {/* CTA Section */}
      <div className="relative container mx-auto px-6 md:px-12 lg:px-20 py-32 lg:py-44 border-b border-background/10">
        <Reveal direction="fade">
          <div className="max-w-5xl mx-auto text-center">
            <OrnamentalDivider label="The Call" className="mb-10" />

            <div className="overflow-hidden">
              <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl mb-10 leading-[0.95]">
                The world cannot
                <span className="block text-secondary italic">afford to wait.</span>
              </h2>
            </div>

            <p className="text-xl md:text-2xl text-background/60 mb-14 max-w-3xl mx-auto font-light leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <a
                href="#vision"
                className="group relative inline-flex items-center justify-center px-14 py-6 bg-secondary text-secondary-foreground font-medium text-[length:var(--text-label-lg)] uppercase tracking-[var(--tracking-wider)] overflow-hidden transition-colors duration-400 glow-gold"
              >
              ...
              <a
                ...
                className="group inline-flex items-center justify-center px-14 py-6 border border-background/15 text-background font-medium text-[length:var(--text-label-lg)] uppercase tracking-[var(--tracking-wider)] hover:border-background/30 hover:bg-background/5 transition-colors duration-400"
              >
      ...
      {/* Footer Links */}
      <div className="relative container mx-auto px-6 md:px-12 lg:px-20 py-20">
        <Reveal direction="up">
          <div className="grid md:grid-cols-12 gap-16">
            ...
            <div className="md:col-span-5">
              <div className="mb-8">
                <div className="w-16 h-16 border border-background/15 flex items-center justify-center mb-6 relative group">
                  ...
                  <div className="absolute inset-0 border border-secondary/0 group-hover:border-secondary/20 transition-colors duration-400" />
                </div>
                <span className="font-serif text-3xl block mb-2">Rafael Grossi</span>
                <p className="text-background/60 text-sm uppercase tracking-[var(--tracking-wide)]">
            ...
            <div className="md:col-span-3" role="navigation" aria-label="Footer navigation">
              <h4 className="font-medium text-[length:var(--text-label)] uppercase tracking-[var(--tracking-ultra)] mb-8 text-background/60">
                Sections
              </h4>
            ...
            <div className="md:col-span-4">
              ...
              <ul className="space-y-4">
                <li>
                  ...
                  >
                    <div className="w-10 h-10 border border-background/20 flex items-center justify-center group-hover:border-secondary group-hover:bg-secondary/10 transition-[border-color,background-color] duration-300">
