    ...
    <footer className="bg-foreground text-background relative overflow-hidden">
      ...
      >
        <div className={`max-w-5xl mx-auto text-center transition-[opacity,transform] duration-800 ${ctaAnim.inView ? 'opacity-100' : 'opacity-0'}`}>
          ...
          <p className={`text-xl md:text-2xl text-background/60 mb-14 max-w-3xl mx-auto font-light leading-relaxed transition-[opacity,transform] duration-800 delay-500 ${ctaAnim.inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            For a United Nations that works—in a dangerous world, with
            everybody, for everybody, and open to everybody.
          </p>

          <div className={`flex flex-col sm:flex-row gap-6 justify-center transition-[opacity,transform] duration-800 delay-700 ${ctaAnim.inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <a
              href="#vision"
              className="group relative inline-flex items-center justify-center px-14 py-6 bg-secondary text-secondary-foreground font-medium text-[11px] uppercase tracking-[0.25em] overflow-hidden transition-colors duration-400 glow-gold"
            >
            ...
            <a
              ...
              className="group inline-flex items-center justify-center px-14 py-6 border border-background/15 text-background font-medium text-[11px] uppercase tracking-[0.25em] hover:border-background/30 hover:bg-background/5 transition-colors duration-400"
            >
      ...
      <button
        onClick={scrollToTop}
        className={`fixed bottom-8 right-8 z-50 w-12 h-12 bg-secondary text-secondary-foreground flex items-center justify-center hover:bg-accent transition-[opacity,transform,background-color] duration-400 group glow-gold ${
