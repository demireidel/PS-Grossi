  ...
  return (
    <section id="global-south" className="py-32 lg:py-48 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-20 relative">
        ...
        <div
          ref={headerRef}
          className={`transition-[opacity,transform] duration-800 ${headerInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}
        >
          <SectionHeader
            number="07"
        ...
        <div
          ref={contentRef}
          className={`bg-primary text-primary-foreground p-12 lg:p-16 mb-20 transition-[opacity,transform] duration-800 delay-200 ${contentInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}
        >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-[2px] bg-border mb-20">
          {stats.map((stat, index) => (
            <div
              key={stat.label}
              className={`group p-8 lg:p-10 bg-card text-center transition-[opacity,transform,background-color] duration-600 relative overflow-hidden hover:bg-foreground ${
        ...
        <div className={`relative aspect-[16/9] lg:aspect-cinema overflow-hidden mb-20 group transition-[opacity,transform] duration-800 ${contentInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
          <Image
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className={`transition-[opacity,transform] duration-800 ${contentInView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
          ...
          <div className={`relative aspect-[4/3] overflow-hidden transition-[opacity,transform] duration-800 delay-300 ${contentInView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
            <Image
