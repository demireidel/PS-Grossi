      ...
      <div className="relative">
        ...
        <Reveal direction="fade" threshold={0.05}>
          <div className="relative mb-32">
                ...
                <div className="flex items-center px-8 lg:px-20 pb-[10%]">
                  <div className="max-w-2xl">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <span className="text-white/60 text-[length:var(--text-label)] uppercase tracking-[var(--tracking-ultra)] text-shadow-overlay">Human Dignity</span>
                    </div>
            ...
            />
            <div className="absolute top-[10%] left-8 w-16 h-16 border-l-2 border-t-2 border-white/20 z-20" />
            <div className="absolute bottom-[10%] right-8 w-16 h-16 border-r-2 border-b-2 border-white/20 z-20" />
          </div>
        </Reveal>
