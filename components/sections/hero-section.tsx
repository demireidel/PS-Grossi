  ...
  return (
    <section className="relative min-h-screen h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-20 text-center">
        {/* Ornamental line */}
        <div className={`flex items-center justify-center gap-6 mb-14 transition-all duration-1000 delay-200 ${loaded ? "opacity-100" : "opacity-0"}`}>
          <span className={`h-px bg-gradient-to-r from-transparent via-secondary/60 to-secondary/60 transition-all duration-1200 delay-500 ${loaded ? "w-28" : "w-0"}`} />
          <div className="w-1.5 h-1.5 rotate-45 border border-secondary/50 transition-all duration-1000 delay-700" />
          <span className={`h-px bg-gradient-to-l from-transparent via-secondary/60 to-secondary/60 transition-all duration-1200 delay-500 ${loaded ? "w-28" : "w-0"}`} />
        </div>
        ...
        <div className="overflow-hidden mb-8">
          <h1
            className={`font-serif text-5xl md:text-7xl lg:text-8xl xl:text-9xl text-white font-normal leading-[0.85] tracking-tight text-shadow-premium transition-all duration-1200 delay-500 ${
        ...
        <div className="overflow-hidden">
          <p
            className={`font-serif text-2xl md:text-4xl lg:text-5xl xl:text-6xl text-white/80 mb-14 tracking-wide transition-all duration-1000 delay-700 ${
              loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
        ...
        <p
          className={`text-base md:text-lg lg:text-xl text-white/60 max-w-2xl mx-auto font-light leading-relaxed tracking-wide text-pretty transition-all duration-1000 delay-800 ${
            loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        >
      ...
      <div className={`absolute top-[6%] left-10 w-20 h-20 transition-all duration-1200 delay-1000 ${loaded ? "opacity-100" : "opacity-0"}`}>
      ...
      <div className={`absolute top-[6%] right-10 w-20 h-20 transition-all duration-1200 delay-1000 ${loaded ? "opacity-100" : "opacity-0"}`}>
      ...
      <div className={`absolute bottom-[6%] left-10 w-20 h-20 transition-all duration-1200 delay-1000 ${loaded ? "opacity-100" : "opacity-0"}`}>
      ...
      <div className={`absolute bottom-[6%] right-10 w-20 h-20 transition-all duration-1200 delay-1000 ${loaded ? "opacity-100" : "opacity-0"}`}>
